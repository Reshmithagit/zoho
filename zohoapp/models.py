...
class vendor_table(models.Model):
    ...
    saddress=models.CharField(max_length=255,default='')
...
class mail_table(models.Model):
    user=models.ForeignKey(User,on_delete=models.CASCADE,null=True,default='')
    vendor=models.ForeignKey(vendor_table,on_delete=models.CASCADE,null=True)
    mail_from=models.TextField(max_length=255)
    mail_to=models.TextField(max_length=255)
...
class vendor_tableE(models.Model):
    ...
    baddress=models.CharField(max_length=255,default='',null=True,blank=True)
    ...
    saddress=models.CharField(max_length=255,default='',null=True,blank=True)
...
class Journal(models.Model):
    ...
    user = models.ForeignKey(User, on_delete=models.CASCADE, null=True, blank=True)
    date = models.DateField()
    journal_no = models.CharField(max_length=15, unique=True)  
